...
/* Definitions for readDHTTask */
osThreadId_t readDHTTaskHandle;
const osThreadAttr_t readDHTTask_attributes = {
  .name = "readDHTTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal1,
};
/* Definitions for StartBlinkLedTa */
osThreadId_t StartBlinkLedTaHandle;
const osThreadAttr_t StartBlinkLedTa_attributes = {
  .name = "StartBlinkLedTa",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* Definitions for logFileMutex */
osMutexId_t logFileMutexHandle;
const osMutexAttr_t logFileMutex_attributes = {
  .name = "logFileMutex"
};
/* Definitions for alertFileMutex */
osMutexId_t alertFileMutexHandle;
const osMutexAttr_t alertFileMutex_attributes = {
  .name = "alertFileMutex"
};
/* Definitions for DHT_SEM */
osSemaphoreId_t DHT_SEMHandle;
const osSemaphoreAttr_t DHT_SEM_attributes = {
  .name = "DHT_SEM"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  osKernelInitialize();
  /* Create the mutex(es) */
  /* creation of logFileMutex */
  logFileMutexHandle = osMutexNew(&logFileMutex_attributes);

  /* creation of alertFileMutex */
  alertFileMutexHandle = osMutexNew(&alertFileMutex_attributes);
  ...
  /* creation of DHT_SEM */
  DHT_SEMHandle = osSemaphoreNew(1, 1, &DHT_SEM_attributes);
  ...
  /* creation of readDHTTask */
  readDHTTaskHandle = osThreadNew(startReadDHTTask, NULL, &readDHTTask_attributes);

  /* creation of StartBlinkLedTa */
  StartBlinkLedTaHandle = osThreadNew(startBlinkLed, NULL, &StartBlinkLedTa_attributes);
