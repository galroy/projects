...
/* Definitions for blinkBlueLedTas */
osThreadId_t blinkBlueLedTasHandle;
const osThreadAttr_t blinkBlueLedTas_attributes = {
  .name = "blinkBlueLedTas",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for playBzrTask */
osThreadId_t playBzrTaskHandle;
const osThreadAttr_t playBzrTask_attributes = {
  .name = "playBzrTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
void startPlayBzr(void *argument);
...
int main(void)
{
  ...
  blinkRedLedTaskHandle = osThreadNew(startBlinkLed, (void*) &ledRed, &blinkRedLedTask_attributes);

  /* creation of blinkBlueLedTas */
  blinkBlueLedTasHandle = osThreadNew(startBlinkLed, (void*) &ledBlue, &blinkBlueLedTas_attributes);

  /* creation of playBzrTask */
  playBzrTaskHandle = osThreadNew(startPlayBzr, (void*) &buzzer, &playBzrTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LEDBLUE_Pin|LEDRED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LEDBLUE_Pin LEDRED_Pin */
  GPIO_InitStruct.Pin = LEDBLUE_Pin|LEDRED_Pin;
...
/* USER CODE BEGIN Header_startPlayBzr */
/**
* @brief Function implementing the playBzrTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startPlayBzr */
__weak void startPlayBzr(void *argument)
{
  /* USER CODE BEGIN startPlayBzr */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END startPlayBzr */
}
